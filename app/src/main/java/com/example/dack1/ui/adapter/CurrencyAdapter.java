...
import com.example.dack1.util.SessionManager; // <-- Đã sửa: import SessionManager
...
public class CurrencyAdapter extends BaseAdapter {
    ...
    public CurrencyAdapter(Context ctx, List<Item> data, String selectedCode) {
        ...
        this.sessionManager = new SessionManager(ctx); // <-- THÊM DÒNG NÀY
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View.OnClickListener choose = vv -> {
            ...
            // ĐÂY LÀ DÒNG ĐÃ SỬA:
            sessionManager.setCurrency(it.code, it.symbol);
